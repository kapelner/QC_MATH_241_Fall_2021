...
\title{MATH 241 Fall \the\year~Homework \#6}
...
\date{NOT DUE but covered on the final exam \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, read about the central limit theorem, confidence intervals and hypothesis tests for one proportion.
...
\easysubproblem{Consider $H_0$: Aliens do not exist vs $H_a$: Aliens do exist. Why is this a \qu{standard} hypothesis test? }\spc{1}

\easysubproblem{Describe a person using English who has a high $\alpha$ for $H_0$: Aliens do not exist vs $H_a$: Aliens do exist. }\spc{1}

\easysubproblem{Describe a person using English who has a low $\alpha$ for $H_0$: Aliens do not exist vs $H_a$: Aliens do exist. }\spc{1}

\easysubproblem{Describe a person using English who has a high $\alpha$ for $H_0$: Aliens do exist vs $H_a$: Aliens do not exist. }\spc{1}

\easysubproblem{Describe a person using English who has a low $\alpha$ for $H_0$: Aliens do exist vs $H_a$: Aliens do not exist.  }\spc{2}
